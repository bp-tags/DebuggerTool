...
namespace UnityGameFramework.Runtime
{
    public partial class DebuggerComponent
    {
        ...
        {
            private DebugerSetting m_SettingComponent = null;
            ...
            {
                m_SettingComponent = new DebugerSetting();

                Application.logMessageReceived += OnLogMessageReceived;
                m_LockScroll = m_LastLockScroll = m_SettingComponent.LockScroll;
                m_InfoFilter = m_LastInfoFilter = m_SettingComponent.InfoFilter;
                m_WarningFilter = m_LastWarningFilter = m_SettingComponent.WarningFilter;
                m_ErrorFilter = m_LastErrorFilter = m_SettingComponent.ErrorFilter;
                m_FatalFilter = m_LastFatalFilter = m_SettingComponent.FatalFilter;
            }
